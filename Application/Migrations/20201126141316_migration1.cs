    ...
    public partial class migration1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Budgets", x => x.DepartmentID);
                    table.ForeignKey(
                        name: "FK_Budgets_Employees_ManagerEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quotations", x => x.EnrollmentID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_ManagerEmployeeId",
                table: "Budgets",
